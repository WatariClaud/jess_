...
CREATE TABLE tickets (id SERIAL PRIMARY KEY, userid integer, datecreated VARCHAR (50), status VARCHAR (11), ispaid boolean, amount VARCHAR (50), spaceid VARCHAR(100));